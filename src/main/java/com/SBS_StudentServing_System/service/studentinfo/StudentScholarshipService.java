...
public class StudentScholarshipService {
    ...
    private StudentScholarship toEntity(StudentScholarshipDto dto) {
        ...
        if (dto.getScholarshipId() != null) {
            Scholarship scholarship = scholarshipRepository.findById(Long.valueOf(dto.getScholarshipId()))
                    .orElseThrow(() -> new RuntimeException("Scholarship not found: " + dto.getScholarshipId())).getScholarship();
